...
<section id="how-pricing-works" class="bg-white">
  <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
    <div class="mx-auto max-w-screen-md">
      ...
      <p class="font-light text-gray-500 sm:text-lg">The catch is interruption. When EC2 needs the capacity back, it reclaims your instance after a two-minute warning. That is the whole trade-off: everything hard about Spot comes from handling that two-minute notice well.</p>
    </div>
  </div>
</section>
...
<section id="autospotting" class="bg-white">
  <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
    <div class="mx-auto max-w-screen-md">
      ...
      <p class="mb-4 font-light text-gray-500 sm:text-lg">It picks compatible instance types based on the On-Demand instance you already run, diversifies across them, drains load balancer traffic before an instance is reclaimed, and fails over to On-Demand automatically when Spot capacity is short, returning to Spot once the market recovers. Remove the tag and the group reverts to plain On-Demand.</p>
